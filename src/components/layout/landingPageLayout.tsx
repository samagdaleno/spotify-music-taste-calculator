...
export default function LandingPageLayout({ children }: LayoutProps) {
    ...
    const [selectedTimeframe, setSelectedTimeframe] = useState<string>("long_term"); 
    const [selectedTrackList, setSelectedTrackList] = useState<any[]>(getLSTracksListData("long_term"));
    const userData: UserData = getLSUserData();
    const selectedTermTrackList = getLSTracksListData("long_term"); 
